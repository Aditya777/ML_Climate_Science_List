...
for nset in range(n_iter):
    ...
    modelx1.fit(x_train, y_train, epochs=10,batch_size=n_batch,validation_split=0.2)
    modelx1.save_weights('./weights/best_'+str(n_inputs)+'_'+str(n_halo)+'_yearly_pole_2fields')
